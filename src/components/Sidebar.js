            ...
            <ul className='flex flex-col w-48 pt-4'>
                ...
                <Link to="/">
                    <li className='hover:bg-gray-200 rounded-lg'>
                        <div className=' flex items-center space-x-8 h-10'>
                            <div className='ml-3'>
                                <svg viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet" focusable="false" className="w-6 h-6" ><g ><path d="M10,8l6,4l-6,4V8L10,8z M21,3v18H3V3H21z M20,4H4v16h16V4z" className="style-scope yt-icon"></path></g></svg>
                            </div>
