    ...
    return (
        <div className='grid grid-flow-col mx-1 sticky bg-white top-0 items-center'>
            <div className='col-span-1 flex items-center justify-center '>
                ...
                {/* 3 bars */}
                <div className='w-10 h-10 flex items-center rounded-full hover:bg-slate-200'>
                    {/* 3 Bars */}
                    <svg
                        onClick={() => toggleMenuHandler()}
                        xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="h-7 m-auto cursor-pointer">
